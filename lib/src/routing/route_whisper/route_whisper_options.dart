...
/// [model] for a [RouteWhisper] options data structure.
///
///
/// Defines and stores properties that indicates the behavior or instructions for the [RouteWhisper] that this structure
/// belongs to.
final class RouteWhisperOptions {
